...
class Dialog: UIView, UIPickerViewDelegate, UIPickerViewDataSource{
    ...
    func setupView() {
        ...
        NSNotificationCenter.defaultCenter().addObserver(self, selector:#selector(Dialog.keyboardWillHide(_:)), name: UIKeyboardWillHideNotification, object: nil);
    }
    ...
    private func addButtonsToView(container: UIView) {
        ...
        self.cancelButton.addTarget(self, action: #selector(Dialog.buttonTapped(_:)), forControlEvents: UIControlEvents.TouchUpInside)
        ...
        self.doneButton.addTarget(self, action: #selector(Dialog.buttonTapped(_:)), forControlEvents: UIControlEvents.TouchUpInside)
